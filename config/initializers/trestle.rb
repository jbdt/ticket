Trestle.configure do |config|
  config.menu do
    ...
    if current_user.admin?
      item "Sidekiq", "/a/sidekiq", icon: "fa fa-cogs", priority: 99
    end
  end
  ...
  #
  config.footer = '<p>Powered by <a href="https://devs365.com/" target="_blank">Devs 365</a></p>'.html_safe
  ...
  #
  config.root_breadcrumbs = -> { [Trestle::Breadcrumb.new("..", Trestle.config.root)] }
